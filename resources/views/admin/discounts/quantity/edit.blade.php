...
@section('title', 'تعديل خصم الكمية')
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card shadow-lg border-0 rounded-lg">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.quantity-discounts.update', $quantityDiscount) }}" method="POST">
                        @csrf
                        @method('PUT')
                                    ...
                                    <select name="product_id" id="product_id"
                                        ...
                                        @foreach($products as $product)
                                            <option value="{{ $product->id }}"
                                                {{ old('product_id', $quantityDiscount->product_id) == $product->id ? 'selected' : '' }}>
                                                {{ $product->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="number" name="min_quantity" id="min_quantity"
                                           value="{{ old('min_quantity', $quantityDiscount->min_quantity) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="number" name="max_quantity" id="max_quantity"
                                           value="{{ old('max_quantity', $quantityDiscount->max_quantity) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <select name="type" id="type"
                                        ...
                                        <option value="percentage" {{ old('type', $quantityDiscount->type) == 'percentage' ? 'selected' : '' }}>
                                            نسبة مئوية
                                        </option>
                                        <option value="fixed" {{ old('type', $quantityDiscount->type) == 'fixed' ? 'selected' : '' }}>
                                            مبلغ ثابت
                                        </option>
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="number" name="value" id="value"
                                           value="{{ old('value', $quantityDiscount->value) }}"
                                           step="0.01"
